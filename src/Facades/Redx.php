 ...
 * @method static array updateParcel(string $trackingId, string $propertyName, string $newValue, ?string $reason = null)
 * @method static array updateParcelRaw(array $payload)
 * @method static array cancelParcel(string $trackingId, ?string $reason = null)
 * @method static array areas(array $query = [])
 * @method static array areasByPostCode(string|int $postCode)
 * @method static array areasByDistrictName(string $districtName)
 * @method static array createPickupStore(array $payload)
 * @method static array pickupStores(array $query = [])
 * @method static array pickupStoreDetails(string|int $pickupStoreId)
 * @method static array stores(array $query = [])
 * @method static array calculateCharge(array $query)
